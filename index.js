...
legendSvg
  ...
  .text("% of population in Food Desert");

var g = svg.append("g");

Promise.all([map_data, access_data, socio_data]).then(function (values) {
  console.log(values);
  ...
  values[0].features.forEach(function (v_0) {
    ...
    v_0.socio_data = result[0] !== undefined ? result[0] : console.log("null");
